...
public:
   ...
   * @return
   */
  RC create_index(Trx *trx, const char *dbname, const char *relation_name, const char *index_name, char *attribute_name[10],int attribute_num,int is_unique);
   ...
   * @return
   */
  RC insert_record(Trx * trx, const char *dbname, const char *relation_name, size_t record_num, const size_t value_num[], const Value values[][MAX_NUM]);
